package com.lpf.book.config.aop;
...
public class ViewModelParameterAop {
    ...
    @Pointcut("@annotation(com.lpf.book.util.ump.ViewModelParameter)")
    public void viewModelParameter() {
    }

    @Pointcut("@annotation(com.lpf.book.util.ump.ViewModelParameters)")
